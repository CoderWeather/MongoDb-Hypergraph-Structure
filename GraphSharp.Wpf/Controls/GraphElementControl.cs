...
namespace GraphSharp.Controls
{
	...
	{
		public HighlightInfoChangedEventArgs(RoutedEvent evt, object source, object oldHighlightInfo,
	...
	public static class GraphElementBehaviour
	{
		...
		internal static readonly RoutedEvent HighlightTriggeredEvent =
			EventManager.RegisterRoutedEvent("HighlightTriggered", RoutingStrategy.Bubble,
				typeof(HighlightTriggerEventHandler), typeof(GraphElementBehaviour));

		public static readonly RoutedEvent HighlightInfoChangedEvent =
			EventManager.RegisterRoutedEvent("HighlightInfoChanged", RoutingStrategy.Bubble,
				typeof(HighlightInfoChangedEventHandler), typeof(GraphElementBehaviour));
		...
		private static readonly DependencyPropertyKey IsSemiHighlightedPropertyKey =
			DependencyProperty.RegisterAttachedReadOnly("IsSemiHighlighted", typeof(bool),
		...
		private static readonly DependencyPropertyKey SemiHighlightInfoPropertyKey =
			DependencyProperty.RegisterAttachedReadOnly("SemiHighlightInfo", typeof(object),
				typeof(GraphElementBehaviour), new PropertyMetadata(null));
		...
		private static object HighlightTrigger_Coerce(DependencyObject d, object baseValue)
		{
			...
			{
				Debug.WriteLine("Exception during HighlightTrigger_Coerce - likely the graph is still animating: " +
					ex);
			}
