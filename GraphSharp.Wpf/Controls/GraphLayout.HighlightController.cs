...
namespace GraphSharp.Controls
{
		...
		where TGraph : class, IBidirectionalGraph<TVertex, TEdge>
	{
		...
		public IEnumerable<TVertex> HighlightedVertices => highlightedVertices.Keys.ToArray();

		public IEnumerable<TVertex> SemiHighlightedVertices => semiHighlightedVertices.Keys.ToArray();

		public IEnumerable<TEdge> HighlightedEdges => highlightedEdges.Keys.ToArray();

		public IEnumerable<TEdge> SemiHighlightedEdges => semiHighlightedEdges.Keys.ToArray();
