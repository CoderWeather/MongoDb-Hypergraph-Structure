...
namespace GraphSharp.Algorithms.Highlight
{
	public abstract class
		HighlightAlgorithmBase<TVertex, TEdge, TGraph, TParameters> : IHighlightAlgorithm<TVertex, TEdge, TGraph>
		where TVertex : class
		...
		where TParameters : class, IHighlightParameters
	{
		...
		IHighlightParameters IHighlightAlgorithm<TVertex, TEdge, TGraph>.Parameters => Parameters;
