...
{
	public class
		LayeredTopologicalSortAlgorithm<TVertex, TEdge> : AlgorithmBase<IVertexAndEdgeListGraph<TVertex, TEdge>>
		where TEdge : IEdge<TVertex>
	{
		...
		private readonly List<IList<TVertex>>
			layers = new List<IList<TVertex>>(); //the list of the vertices in the layers
		...
		/// </summary>
		public IList<IList<TVertex>> Layers => layers;
