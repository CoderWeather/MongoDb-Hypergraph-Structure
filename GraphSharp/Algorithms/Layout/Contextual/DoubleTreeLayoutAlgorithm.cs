...
namespace GraphSharp.Algorithms.Layout.Contextual
{
	...
	public class DoubleTreeLayoutAlgorithm<TVertex, TEdge, TGraph> : ParameterizedLayoutAlgorithmBase<TVertex, TEdge,
		TGraph, DoubleTreeVertexType, object, DoubleTreeLayoutParameters>
		where TVertex : class
		...
		where TGraph : IBidirectionalGraph<TVertex, TEdge>
	{
		...
		public DoubleTreeLayoutAlgorithm(TGraph visitedGraph, IDictionary<TVertex, Point> vertexPositions,
			IDictionary<TVertex, Size> vertexSizes, DoubleTreeLayoutParameters oldParameters, TVertex selectedVertex)
		...
		protected override DoubleTreeLayoutParameters DefaultParameters => new DoubleTreeLayoutParameters();
		...
		protected override void InternalCompute()
		{
			...
			var side2Direction = Parameters.Direction;
			var side1Direction = Parameters.Direction;
			...
			//
			var side1LayoutAlg =
				new SimpleTreeLayoutAlgorithm<TVertex, Edge<TVertex>, BidirectionalGraph<TVertex, Edge<TVertex>>>(
        ...
        public static void SeparateSides(TGraph graph, TVertex selectedVertex, out HashSet<TVertex> side1,
