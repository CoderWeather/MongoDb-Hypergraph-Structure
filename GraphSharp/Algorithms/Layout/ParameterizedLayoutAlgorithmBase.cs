...
namespace GraphSharp.Algorithms.Layout
{
		...
		where TParam : class, ILayoutParameters
	{
		...
		{
			return new LayoutIterationEventArgs<TVertex, TEdge, TVertexInfo, TEdgeInfo>(iteration, statusInPercent,
				message, vertexPositions, vertexInfos, edgeInfos);
		}
