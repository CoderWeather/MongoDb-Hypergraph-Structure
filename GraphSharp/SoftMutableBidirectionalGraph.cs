...
{
	public class SoftMutableBidirectionalGraph<TVertex, TEdge> : BidirectionalGraph<TVertex, TEdge>,
		...
		where TEdge : IEdge<TVertex>
	{
		...
		public IEnumerable<TVertex> HiddenVertices => hideHelper.HiddenVertices;

		public int HiddenVertexCount => hideHelper.HiddenVertexCount;
		...
		public IEnumerable<TEdge> HiddenEdges => hideHelper.HiddenEdges;

		public int HiddenEdgeCount => hideHelper.HiddenEdgeCount;
