...
namespace QuickGraph.Algorithms
{
    ...
    public static class AlgorithmExtensions
	{
			...
			where TEdge : IEdge<TVertex>
		{
			...
			return delegate(TVertex v, out IEnumerable<TEdge> edges) { return predecessors.TryGetPath(v, out edges); };
		}
			...
			where TEdge : IEdge<TVertex>
		{
			...
			var dijkstra =
				new UndirectedDijkstraShortestPathAlgorithm<TVertex, TEdge>(visitedGraph, weights, distanceRelaxer);
